...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://saniuzzaman.dev/games' },
  openGraph: {
    type: 'website',
    ...
    images: [{ url: 'https://saniuzzaman.dev/og_image.png', width: 1200, height: 630, alt: 'Saniuzzaman Robin - Games' }],
  },
  twitter: {
...
const schemaItems = [
  { name: 'Snake', description: 'Navigate the neon serpent, collect data packets, avoid collisions.', url: 'https://saniuzzaman.dev/games/snake' },
  { name: 'Tetris', description: 'Drop tetrominos, clear lines, survive the cascade.', url: 'https://saniuzzaman.dev/games/tetris' },
  { name: 'Memory Match', description: 'Flip holographic cards, find matching pairs, beat the clock.', url: 'https://saniuzzaman.dev/games/memory' },
];
...
export default function GamesPage() {
  ...
  return (
    <main className="bg-neutral-5 text-neutral-90 min-h-dvh">
      ...
      <section className="relative overflow-hidden px-6 py-20 md:px-12 lg:px-16">
        <div className="cyber-grid pointer-events-none absolute inset-0 opacity-30" />
        <div className="bg-primary-50/4 pointer-events-none absolute top-1/4 left-1/4 h-96 w-96 rounded-full blur-3xl" />
        <div className="bg-secondary-50/4 pointer-events-none absolute right-1/4 bottom-1/4 h-64 w-64 rounded-full blur-3xl" />
