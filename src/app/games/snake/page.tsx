    ...
    <>
      ...
      <div className="bg-midnight-50 text-midnight-900 flex h-dvh flex-col overflow-hidden">
        ...
        <div className="border-midnight-300 bg-midnight-100/50 flex items-center justify-between border-b px-4 py-3">
          ...
          <button
            onClick={start}
            className="border-primary-50 text-primary-50 hover:bg-primary-50/10 font-poppins flex items-center gap-2 rounded border px-4 py-2 text-xs tracking-wider uppercase transition-colors lg:text-sm"
          >
                    ...
                    {(Object.keys(DIFFICULTIES) as DiffKey[]).map((key) => {
                      ...
                      return (
                        <button
                          ...
                          className="font-poppins flex flex-col items-center gap-0.5 rounded-sm border px-1 py-1.5 transition-all duration-200 md:px-2 md:py-2.5"
                          style={{
