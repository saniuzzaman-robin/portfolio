    ...
    <main className="bg-midnight-900 text-midnight-950 min-h-screen">
      ...
      <section className="relative overflow-hidden px-6 pt-24 pb-16 md:px-12 lg:px-20">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          >
            <div className="bg-midnight-100 border-midnight-200 flex items-center gap-2 rounded-full border px-4 py-2">
          ...
          >
            <div className="bg-midnight-100 border-midnight-200 rounded-2xl border p-5">
