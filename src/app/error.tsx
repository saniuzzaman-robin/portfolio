    ...
    <main className="flex min-h-dvh items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link
            href="/"
            className="text-neutral-60 font-poppins border border-white/10 px-6 py-3 text-sm tracking-widest uppercase transition-colors duration-200 hover:text-white"
          >
            Go home
          </Link>
        </div>
