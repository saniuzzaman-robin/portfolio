...
export function StatCard({
  ...
  return (
    <div
      className={`bg-gradient-to-br ${colorClasses.background} rounded-2xl p-8 border border-neutral-20 hover:border-neutral-30 transition-all duration-300 animate-scale-in hover:shadow-lg group will-change-transform`}
    ...
    >
      ...
      <p
        className={`${colorClasses.text} font-space-grotesk text-3xl md:text-4xl font-bold mb-2`}
      >
        {number}
      </p>
